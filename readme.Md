...
```
LSTM(
  (lstm): LSTM(input_size=4, hidden_size=100, batch_first=True)
...
```text
Predict_stocks_prices
│
├── images/
│   ├── actual_vs_predicted.png
│   └── closing_price.png
│
├── LSTM_predict_stock_prices.ipynb
...
```bash
git clone https://github.com/sushil0126/Predict_stocks_prices.git 
```
...
```bash
jupyter notebook LSTM_predict_stock_prices.ipynb
```
